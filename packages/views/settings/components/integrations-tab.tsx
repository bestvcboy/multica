...
import { LweixinTab } from "./lweixin-tab";
  ...
  const groups: {
    ...
    },
    {
      ...
      entries: [
        ...
        {
          id: "lweixin",
          label: t(($) => $.lweixin.section_title),
          description: t(($) => $.lweixin.page_description),
          icon: <IntegrationChannelIcon channel="lweixin" />,
          content: <LweixinTab />,
          state: lweixin,
        },
      ],
